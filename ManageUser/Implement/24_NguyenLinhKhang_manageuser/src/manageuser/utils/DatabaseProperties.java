 ...
 * DatabaseProperties.java, 14/07/2020, KhangNL
 */
...
/**
 * Class thực hiện đọc file database.properties
 *
 * @author KhangNL
 *
 */
	...
	static {
		try {
			...
			properties.load(new InputStreamReader(
					DatabaseProperties.class.getClassLoader().getResourceAsStream(Constant.DATABASE_PROPERTIES), Constant.UTF8));
